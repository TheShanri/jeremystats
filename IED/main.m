...
%%%next step... RN it is using first channel as an anchor, but doing wonky
%%%stuff with the ampltitude placement. Trying to find a minmum... not sure
%%%where in the code that's happening. 

% Update code to take just the amp. and also wtf is going on with the
% halfwidths?
