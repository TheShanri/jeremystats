...
CSD Center Slices PIPELINE: sfx=30000.0 Hz | window ±20.0 ms | anchor: firstCh max (±5.0 ms)
Found 13 SOLID, 4 SPUTTER events (by filenames).
Saved SOLID: C:\Users\Z390\Desktop\IED DATA\Preped Data - M13s2aug1\CSD Center Slices Output\CSD_CenterSlices_SOLID.png
Saved SPUTTER: C:\Users\Z390\Desktop\IED DATA\Preped Data - M13s2aug1\CSD Center Slices Output\CSD_CenterSlices_SPUTTER.png
CSD Time-Average Slices: sfx=30000.0 Hz | capture ±20.0 ms | avg window [-5.0,+15.0] ms | anchor: firstCh max (±5.0 ms)
Found 13 SOLID, 4 SPUTTER events (by filenames).
Saved SOLID: C:\Users\Z390\Desktop\IED DATA\Preped Data - M13s2aug1\CSD Center Slices Output\CSD_TimeAvg_SOLID.png
Saved SPUTTER: C:\Users\Z390\Desktop\IED DATA\Preped Data - M13s2aug1\CSD Center Slices Output\CSD_TimeAvg_SPUTTER.png
Master SOLID compact montage saved: C:\Users\Z390\Desktop\IED DATA\Preped Data - M13s2aug1\Pipeline Output\Master_Compact_SOLID.png
Master SPUTTER compact montage saved: C:\Users\Z390\Desktop\IED DATA\Preped Data - M13s2aug1\Pipeline Output\Master_Compact_SPUTTER.png
Warning: Failed to merge stats from CSDRaster: To assign to or create a variable in a table, the
number of rows must match the height of the table. 
> In Pipeline_Main>tryAddCSV (line 268)
In Pipeline_Main (line 112)
In main (line 21) 
Warning: Failed to merge stats from CSDCenterSlices: To assign to or create a variable in a table,
the number of rows must match the height of the table. 
> In Pipeline_Main>tryAddCSV (line 268)
In Pipeline_Main (line 113)
In main (line 21) 
Warning: Failed to merge stats from CSDTimeAvg: To assign to or create a variable in a table, the
number of rows must match the height of the table. 
> In Pipeline_Main>tryAddCSV (line 268)
In Pipeline_Main (line 114)
In main (line 21) 