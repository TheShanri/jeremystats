...
%%%next step... sort into Solid, Sputter,Garbage, Flag... and then...
%%%create channel wide average wave form (so e.g average of many solids, to
%%%give you 32 average waveforms to visualize Xplorefinder style